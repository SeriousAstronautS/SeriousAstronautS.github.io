...
(function (module) {
	module.exports = function(modules) {
	    ...
	    if (installedChunkData !== 0) {
	      if (installedChunkData) {
	        ...
	        var promise = new Promise(function(resolve, reject) {
	          ...
	          import('./rollup/_dynamic-require.mjs').then(r => r.default || r).then(dynamicRequire => dynamicRequire( ({ "1": "components/add-entry", "2": "components/dasr-logo", "3": "components/laundry-schedule", "4": "components/schedule", "5": "pages/auth", "6": "pages/club", "7": "pages/index", "8": "pages/instruments", "9": "pages/kds", "10": "pages/laundry", "11": "pages/login", "12": "pages/meetingroom", "13": "pages/vacuumcleaner" }[chunkId] || chunkId) + ".js")).then((chunk) => {
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    const _6a9d31e8 = () => interopDefault(__webpack_require__.e(5).then(__webpack_require__.bind(null, 70)));
	    const _808811cc = () => interopDefault(__webpack_require__.e(6).then(__webpack_require__.bind(null, 71)));
	    const _0103cdb8 = () => interopDefault(__webpack_require__.e(8).then(__webpack_require__.bind(null, 72)));
	    const _3ccfa0f4 = () => interopDefault(__webpack_require__.e(9).then(__webpack_require__.bind(null, 73)));
	    const _100745e9 = () => interopDefault(__webpack_require__.e(10).then(__webpack_require__.bind(null, 74)));
	    const _5ee39796 = () => interopDefault(__webpack_require__.e(11).then(__webpack_require__.bind(null, 75)));
	    const _7b4cc4e2 = () => interopDefault(__webpack_require__.e(12).then(__webpack_require__.bind(null, 76)));
	    const _e8cb87a6 = () => interopDefault(__webpack_require__.e(13).then(__webpack_require__.bind(null, 77)));
	    const _06e6911e = () => interopDefault(__webpack_require__.e(7).then(__webpack_require__.bind(null, 78)));
	    const emptyFn = () => {
	    };
	    ...
	    const DasrLogo = () => __webpack_require__.e(2).then(__webpack_require__.bind(null, 69)).then((c) => wrapFunctional(c.default || c));
	  ...
	  function(module2, __webpack_exports__, __webpack_require__) {
	    ...
	    var render = function render2() {
	      ...
	      }, [_vm._ssrNode('<div class="overflow-y-auto py-4 px-3 bg-white dark:bg-gray-800 h-full left-0 shadow-sm">', "</div>", [_vm._ssrNode('<ul class="space-y-2">', "</ul>", [_vm._ssrNode("<li>", "</li>", [_vm.$auth.loggedIn ? _vm._ssrNode('<span class="items-center flex p-2 text-xl font-semibold text-gray-900 dark:text-white">', "</span>", [_vm._ssrNode('<div class="aspect-square lg:h-12 h-6 rounded-full bg-white overflow-hidden"><img' + _vm._ssrAttr("src", _vm.$auth.$state.user.picture) + ' alt="ProfilePicture" class="w-full h-full object-center object-cover rounded-full"></div> <span class="ml-3 hidden lg:flex lg:flex-col"><span class="text-md">' + _vm._ssrEscape(_vm._s(_vm.$auth.$state.user.name)) + '</span> <span class="text-sm text-gray-500 dark:text-gray-400">' + _vm._ssrEscape("\u0411\u0430\u043B\u0430\u043D\u0441: " + _vm._s(_vm.balance) + "\u20BD") + "</span></span>")], 2) : _vm._ssrNode('<span class="items-center flex p-2 text-base font-semibold text-gray-900 dark:text-white cursor-pointer">', "</span>", [_vm._ssrNode('<div class="aspect-square h-6 rounded-full bg-white overflow-hidden"></div> '), _c("NuxtLink", {
	        attrs: {
	          "to": "/auth"
	        }
	      }, [_c("span", {
	        staticClass: "ml-3 hidden lg:block"
	      }, [_vm._v("\u0412\u043E\u0439\u0442\u0438")])])], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_c("NuxtLink", {
